...
<fmt:message key="text.delete.user.text" var="delete_user_text"/>
<fmt:message key="button.yes" var="yes"/>
<fmt:message key="button.no" var="no"/>
<fmt:message key="page.audi.dealer.delete.user.page" var="delete_page"/>
...
<div align="center">
    ...
    <form action=<%=request.getContextPath()%>"delete" method="post">
        ...
        <a class="btn btn-outline-success btn-sm" href=<%=request.getContextPath()%>"/user/find-all"
           role="button">${no}</a>
