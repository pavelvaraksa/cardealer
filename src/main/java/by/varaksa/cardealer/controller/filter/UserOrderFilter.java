...
/**
 * Class {@code UserOrderFilter} designed for filter requests
 * from unauthenticated users
 *
 * @author Pavel Varaksa
 */
@WebFilter(filterName = "UserOrderFilter")
public class UserOrderFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain) throws IOException, ServletException {
        ...
        if (login == null || role != Role.ADMIN) {
            logger.error("User order filter blocked an attempt to enter a forbidden page");
